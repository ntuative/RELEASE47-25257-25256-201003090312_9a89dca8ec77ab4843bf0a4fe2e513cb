package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            var_35.error("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",true,Core.const_988);
      ...
      private function initializeCore() : void
      {
         ...
         {
            method_1(Habbo.const_25);
            Core.crash("Failed to initialize the core: " + error.message,Core.const_831,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            method_1(Habbo.const_25);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_831,error);
            Core.dispose();
         }
      }
