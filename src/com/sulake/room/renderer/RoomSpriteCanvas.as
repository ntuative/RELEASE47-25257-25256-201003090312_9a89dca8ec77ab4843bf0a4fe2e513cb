package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2011:Number = -10000000;
      
      private var var_2012:Number = -10000000;
      ...
      private var var_1018:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1017 == 0)
         {
            checkMouseHits(var_1016.x,var_1016.y,MouseEvent.MOUSE_MOVE);
         }
         var_1017 = 0;
         ++var_1511;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_55.graphics.beginFill(var_2344);
      ...
      {
         var _loc11_:Number = param1 - var_697 / 2;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_697 != var_2014 || var_696 != var_2015)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         if(_loc6_ < var_408.length)
         {
            var_408.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_408[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         while(_loc1_ < var_300.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1018 != null)
                  {
                     var_1018.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1511,geometry);
                  }
                  else
                  {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2011 || param2 != var_2012)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         _loc12_ += int(var_697 / 2);
         _loc13_ += int(var_696 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_697 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_696))
                  {
