package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1093:uint = 1;
      
      private static const const_491:uint = 0;
      
      private static const const_772:uint = 2;
       
      
      private var var_704:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_772)
            {
               if(var_704 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_704.errorID,var_704);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_704);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1093) : uint(const_491);
      }
