package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected var var_1379:Boolean = false;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_343 = this.getDefinition(_name) as Class;
         if(var_343 == null)
         {
         ...
         try
         {
            xmlClass = var_343.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_938 > 0)
            {
               var_18.close();
               var_18.unload();
               addRequestCounterToUrlRequest(var_326,const_1401 - var_938);
               var_18.load(var_326,_context);
               --var_938;
               return true;
            }
