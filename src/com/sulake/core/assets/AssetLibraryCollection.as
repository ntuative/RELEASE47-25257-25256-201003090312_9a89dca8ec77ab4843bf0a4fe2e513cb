package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1106:LoaderContext;
      
      protected var var_34:Array;
      
      protected var var_531:Array;
      
      private var var_625:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_34 = new Array();
         var_531 = new Array();
         var_1106 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_372 = new AssetLibrary("lib-" + var_625++);
         var_34.push(var_372);
      }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_625++);
         var_531.push(_loc4_);
