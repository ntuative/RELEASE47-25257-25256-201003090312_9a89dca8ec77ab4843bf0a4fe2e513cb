package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1216:String = "AssetLibraryUnloaded";
      
      public static const const_451:String = "AssetLibraryLoaded";
      
      public static const const_1147:String = "AssetLibraryLoadError";
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_405)
         {
            _loc2_ = var_405[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_405[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_689)
         {
            delete var_689[_loc1_];
         }
         if(var_18 != null)
         {
            var_18.dispose();
         ...
         var_298 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1216));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_343 = _loc2_.resource;
         if(var_480)
         {
            AssetLibrary.fetchLibraryContents(this,var_481,var_343);
         }
         var_298 = true;
         dispatchEvent(new Event(AssetLibrary.const_451));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_405[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1005,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_906,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_794,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_405[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      {
         return param1 < var_342.length ? getAssetByName(var_342[param1]) : null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_343[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_405[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_342.splice(var_342.indexOf(_loc2_),1);
      ...
      {
         return var_343 != null ? false : false;
      }
   }
}
