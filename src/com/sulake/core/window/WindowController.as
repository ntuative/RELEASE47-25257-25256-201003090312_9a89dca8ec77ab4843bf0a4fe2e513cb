package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1224:uint = 0;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_130,WindowParam.const_145);
         var _loc2_:* = !testParamFlag(WindowParam.const_115,WindowParam.const_153);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_750 = param1;
         var_619 = !!var_750 ? uint(var_619 | var_1366) : uint(var_619 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1926 + "]";
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_680,var_7);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_7,WindowRedrawFlag.const_836);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_995 || _loc3_.hasGraphicsContext())
         {
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_508))
         {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_200:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_167,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_166,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        ...
                        var_16 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_255,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_362:
                  _context.invalidate(this,var_7.union(var_56),WindowRedrawFlag.const_482);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_869,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_291:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_675,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_219,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_457:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_826);
                  break;
               case WindowNotifyEvent.const_471:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_378:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_482);
                     }
                  }
                  else if(var_16 & 0)
                  {
               ...
               case WindowNotifyEvent.const_219:
                  ...
                  break;
               case WindowNotifyEvent.const_375:
                  var_8.getRegionProperties(null,var_297);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_326:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_578,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_995 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_428)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_357)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_838,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_581,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1366,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_66,true);
         _loc1_.type = WindowNotifyEvent.const_1341;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_66,false);
         _loc1_.type = WindowNotifyEvent.const_1350;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_297 = var_8.rectangle.clone();
               var_56.x = var_7.x;
               var_56.y = var_7.y;
               var_56.width = var_7.width;
               var_56.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_441,this,var_8));
            }
            else
            {
               var_297.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_16,_context,var_7,null,var_624,properties,var_618.concat(),_id) as WindowController;
      ...
      {
         if(var_36 == WindowState.const_374)
         {
            return true;
         }
