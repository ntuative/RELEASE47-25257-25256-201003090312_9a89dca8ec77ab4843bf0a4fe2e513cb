package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1066:String = "increment";
      
      private static const const_486:String = "slider_bar";
      
      private static const const_1067:String = "decrement";
      
      private static const const_761:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_163 = false;
         var_23 = param12;
         _horizontal = param2 == WindowType.const_372;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_441)
         {
            if(var_23 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_761) as WindowController;
      }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_831 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_831) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1066)
            {
               if(var_23)
               {
                  var_567 = true;
            ...
            else if(param2.name == ScrollbarController.const_1067)
            {
               if(var_23)
               {
                  var_567 = true;
            ...
            else if(param2.name == ScrollbarController.const_761)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_870)
         {
