package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1032:String = "TAB_BUTTON_TITLE";
      ...
      {
         if(param2.type == WindowNotifyEvent.const_255)
         {
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1032));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
