package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_776:IItemListWindow;
      
      private var var_331:IScrollbarWindow;
      
      private var var_1406:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_331)
         {
            ...
            if(var_331)
            {
               var_331.addEventListener(WindowEvent.const_247,scrollBarEventProc);
               var_331.addEventListener(WindowEvent.const_218,scrollBarEventProc);
            }
         }
         return var_331;
      }
      ...
      override public function dispose() : void
      {
         if(var_331)
         {
            var_331.removeEventListener(WindowEvent.const_247,scrollBarEventProc);
            var_331.removeEventListener(WindowEvent.const_218,scrollBarEventProc);
            var_331 = null;
         }
         if(var_776)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_776)
         {
            var_776 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_776;
      }
