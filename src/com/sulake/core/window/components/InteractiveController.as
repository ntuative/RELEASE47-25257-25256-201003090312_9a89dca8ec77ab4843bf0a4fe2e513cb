package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_440 = new Array();
         var_440[0] = MouseCursorType.const_330;
         var_440[1] = MouseCursorType.const_38;
         var_440[2] = MouseCursorType.const_330;
         var_440[3] = MouseCursorType.const_330;
         var_440[4] = MouseCursorType.const_38;
         var_440[5] = MouseCursorType.const_38;
         var_440[6] = MouseCursorType.const_330;
         if(var_327 == null)
         {
            var_327 = new Array();
      ...
      {
         param2.push(new PropertyStruct(const_1022,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_739));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1018,param1.toolTipDelay != const_1394));
         return param2;
      }
      ...
      {
         var_935 = param1 == null ? const_739 : param1;
      }
