package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_743:String = "margin_top";
      
      private static const const_1036:String = "_HEADER";
      
      private static const const_744:String = "margin_right";
      
      private static const const_1034:String = "_SCALER";
      
      private static const const_1037:String = "_TITLE";
      
      private static const const_1035:String = "_CONTENT";
      
      private static const const_741:String = "margin_left";
      
      private static const const_742:String = "margin_bottom";
      ...
      private var var_1150:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_741,_loc3_.left,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_743,_loc3_.top,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_744,0 - _loc3_.right,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_742,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1150 == null)
         {
            var_1150 = findChildByTag(const_1036) as IHeaderWindow;
            if(!var_1150)
            {
      ...
      {
         return findChildByTag(const_1034) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1379 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1035) as IWindowContainer;
            if(!var_22)
            {
