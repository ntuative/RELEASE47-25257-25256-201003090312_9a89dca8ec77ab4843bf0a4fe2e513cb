package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1103:String = "content";
      
      private static const const_1104:String = "selector";
      ...
      protected var var_1597:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1597 == null)
         {
            var_1597 = findChildByTag(TabContextController.const_1103) as IWindowContainer;
         }
         return var_1597;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_937 == null)
         {
            var_937 = findChildByTag(TabContextController.const_1104) as ITabSelectorWindow;
            if(var_937 != null)
            {
      ...
      {
         return !!var_915 ? selector.iterator : null;
      }
