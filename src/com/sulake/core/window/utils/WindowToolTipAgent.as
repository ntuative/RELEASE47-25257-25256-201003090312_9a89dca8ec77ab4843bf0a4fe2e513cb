   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IWindowToolTipAgentService
   {
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            ...
            {
               var_243 = _window.context.create("undefined::ToolTip",var_935,WindowType.const_336,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
