package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1437:String = "_INCLUDE";
      
      public static const const_907:String = "_EXCLUDE";
      
      public static const const_1606:String = "_TEMP";
      
      private static const const_1123:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1124:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1380:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1381:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_939,var_1381);
         var_1380 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1124,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1381)
            {
               delete var_1381[_loc1_];
            }
            var_1380.dispose();
            var_1380 = null;
            _context = null;
