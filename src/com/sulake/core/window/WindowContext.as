package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      protected var var_2260:IWindowFactory;
      ...
      protected var var_2262:IInternalWindowServices;
      
      protected var var_96:WindowController;
      
      protected var var_1368:int = -1;
      ...
      protected var var_1101:SubstituteParentController;
      
      private var var_2293:Point;
      
      protected var var_322:DisplayObjectContainer;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_322 = param5;
         var_2262 = new InternalWindowServices(this,param5);
         var_2260 = param3;
         ...
         var_322.addChild(var_89.getDisplayObject());
         var_322.doubleClickEnabled = true;
         var_322.addEventListener(Event.RESIZE,stageResizedHandler);
         var_96 = WindowController(var_89);
         var_1101 = new SubstituteParentController(this);
         var_340 = param7;
      }
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_374)
         {
            param1.destroy();
         }
         return true;
      ...
      {
         _disposed = true;
         var_322.removeEventListener(Event.RESIZE,stageResizedHandler);
         var_322.removeChild(IGraphicContextHost(var_89).getGraphicContext(true) as DisplayObject);
         var_89.destroy();
         var_89 = null;
         var_1101.destroy();
         var_1101 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_89 != null && true)
         {
            if(var_322 is Stage)
            {
               var_89.width = Stage(var_322).stageWidth;
               var_89.height = Stage(var_322).stageHeight;
            }
            else
            {
               var_89.width = var_322.width;
               var_89.height = var_322.height;
            }
         }
      }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_96 && true)
                     {
                        if(var_340 != null)
                        {
                           var_340.mouseEventReceived(_loc2_.type,var_96);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1591 == null)
         {
            var_1591 = new MouseCursorControl(var_322);
         }
         return var_1591;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_351))
         {
