package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_739:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_482:
            ...
            case WindowRedrawFlag.const_826:
               var_738 = var_739.getTheActualState(param1.type,param1.style,param1.state);
               if(var_738 != var_1075)
               {
                  var_237 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_836:
               ...
               break;
            case WindowRedrawFlag.const_274:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_739.getTheActualState(param1.type,param1.style,param1.state) != var_1075;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_785) : uint(const_496);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_738) ? uint(const_786) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_786)
               {
                  ...
                  if(var_237)
                  {
                     ...
                     _loc6_.draw(param1,var_93,var_93.rect,var_738,false);
      ...
      {
         var _loc2_:ISkinRenderer = var_739.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_822)
            {
               _loc2_ = var_739.getSkinRendererByType(param1.type,WindowStyle.const_822);
            }
         }
         return _loc2_;
      }
