package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_622:Dictionary;
      
      private var var_645:Matrix;
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_373)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_373)
                  {
                     _loc15_ = true;
                  ...
                  {
                     var_645.a = _loc13_.width / _loc19_.width;
                     var_645.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_645);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_645,null);
      ...
      override public function dispose() : void
      {
         ...
         var_623 = null;
         for(_loc1_ in var_622)
         {
            _loc2_ = var_622[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_622[_loc1_];
         }
         var_622 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_622[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
