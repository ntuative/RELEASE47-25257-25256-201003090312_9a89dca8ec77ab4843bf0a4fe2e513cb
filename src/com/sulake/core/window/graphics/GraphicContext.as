package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_825:uint = 256;
      ...
      public static const const_1610:uint = 128;
      ...
      public static const const_1157:uint = 16;
      ...
      protected var var_1594:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1189:
               ...
               break;
            case GraphicContext.const_1157:
         ...
         if(var_621)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1594,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1594,16777215);
                  }
                  var_373 += bitmap.width * bitmap.height * 4;
               }
