package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1547:OpenedToWebPopup;
      ...
      private var var_1546:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_890:FriendRequests;
      ...
      private var var_888:IHabboNotifications;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1546 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_890.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_890.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_438.findTab(FriendListTab.const_85).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_890 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_15.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_15.addCategory(new FriendCategory(FriendCategory.const_820,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_402,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_15.addFriend(new Friend(_loc4_));
         }
         var_438 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_512)
         {
            var_512 = new Timer(120000);
            var_512.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_512.start();
         }
         getBuddyRequests();
         registerListeners();
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_512.stop();
            var_512.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_512 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_888)
         {
            var_888.release(new IIDHabboNotifications());
            var_888 = null;
         }
         if(var_187)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_438.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1546.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_890.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_438.findTab(FriendListTab.const_85);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_889.createAvatarImage(param1,AvatarScaleType.const_100);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_890.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_438.findTab(FriendListTab.const_85);
      ...
      {
         var_888 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1547 == null)
         {
            var_1547 = new OpenedToWebPopup(this);
         }
         var_1547.show(x,y);
      }
