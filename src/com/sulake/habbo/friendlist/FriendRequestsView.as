package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_294 && _loc4_.state != FriendRequest.const_323)
            {
      ...
      {
         var_1447 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1446 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1446.procedure = onDismissAllButtonClick;
         var_1447.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_848)
         {
