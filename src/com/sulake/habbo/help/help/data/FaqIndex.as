package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_676 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_677 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_130 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_676.hasItem(param1))
         {
            var_676.getItem(param1).answerText = param2;
         }
