package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1856:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_127:TutorialUI;
      ...
      private var var_668:IHabboConfigurationManager;
      ...
      private var var_1200:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1200 = new CallForHelpData();
         var_1856 = new UserRegistry();
      ...
      override public function dispose() : void
      {
         ...
         if(var_668)
         {
            var_668.release(new IIDHabboConfigurationManager());
            var_668 = null;
         }
         if(_windowManager)
         {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               ...
               if(var_127 != null)
               {
                  var_127.setRoomSessionStatus(true);
               }
               break;
            case RoomSessionEvent.const_103:
               ...
               if(var_127 != null)
               {
                  var_127.setRoomSessionStatus(false);
               }
      ...
      {
         if(var_127 == null && _assetLibrary != null && _windowManager != null)
         {
            var_127 = new TutorialUI(this);
         }
         return var_127 != null;
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_58 = new HelpUI(this,_assetLibrary,_windowManager,var_669,var_187);
         }
         return var_58 != null;
      }
      ...
      {
         var_1200.reportedUserId = param1;
         var_1200.reportedUserName = param2;
         var_58.showUI(HabboHelpViewEnum.const_284);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      public function updateTutorial(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_127.update(param1,param2,param3);
      }
      
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_313 = IHabboCommunicationManager(param2);
         var_984 = new IncomingMessages(this,var_313);
      ...
      {
         var_668 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_668.getKey(param1,param2,param3);
      }
   }
}
