package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_241:String = "TUI_NAME_VIEW";
      
      public static const const_88:String = "TUI_MAIN_VIEW";
      
      public static const const_299:String = "TUI_CLOTHES_VIEW";
      
      public static const const_376:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_503,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_691,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_700,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_105));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_1061 = true;
         if(var_32 != null && (var_32.id == const_241 || var_32.id == const_88))
         {
            showView(const_88);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1389;
         _window.width = _loc2_.width + var_1388;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_503:
               var_1063 = true;
               if(var_32 != null && var_32.id == const_376)
               {
                  showView(const_88);
               }
               break;
            case HabboHelpTutorialEvent.const_691:
               if(var_32 != null && var_32.id == const_299)
               {
                  var_1324 = true;
                  disposeWindow();
               }
      ...
      {
         var_1062 = true;
         if(var_32 != null && (var_32.id == const_299 || var_32.id == const_88))
         {
            showView(const_88);
         }
      }
      ...
      {
         return var_1062 && var_1061 && var_1063;
      }
   }
}
