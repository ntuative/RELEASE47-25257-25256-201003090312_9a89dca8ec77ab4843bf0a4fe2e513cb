package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_648 == null || _loc3_ < 0 || _loc3_ >= var_648.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_648[_loc3_];
            main.showUI(HabboHelpViewEnum.const_615);
            main.tellUI(HabboHelpViewEnum.const_615,null);
         }
      }
   }
}
