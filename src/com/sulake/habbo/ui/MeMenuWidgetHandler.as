package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_827,onAvatarEffectsChanged);
         ...
         if(var_187)
         {
            var_187.events.addEventListener(HabboToolbarEvent.const_87,onHabboToolbarEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_627);
         _loc1_.push(RoomWidgetDanceMessage.const_587);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_673);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_591);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_582);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_676);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_660);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_726);
         _loc1_.push(RoomWidgetStopEffectMessage.const_725);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1352);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_994);
         _loc1_.push(RoomWidgetToolbarMessage.const_537);
         _loc1_.push(RoomWidgetToolbarMessage.const_532);
         ...
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_601);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_703);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_657);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_551);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1293);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_604);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_577);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_498));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_703:
               ...
               break;
            case RoomWidgetWaveMessage.const_627:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_587:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_673:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_591:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_582:
               if(var_10 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_726:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_689)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_261,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_660:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_863:
                        _catalog.openCatalogPage(CatalogPageName.const_1138,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_954:
                        var_10.toggleInventoryPage(InventoryCategory.const_271);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_725:
            ...
            case RoomWidgetSetToolbarIconMessage.const_930:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_994:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_601:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_537:
               ...
               break;
            case RoomWidgetToolbarMessage.const_532:
               ...
               if(var_187 && false)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_384,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_712:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == HabboClubLevelEnum.const_75)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_354,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_845));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_354,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1292));
                     }
                  }
               ...
               break;
            case RoomWidgetRedeemClubPromoMessage.const_657:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_551:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_283,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_604:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_283,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_577:
