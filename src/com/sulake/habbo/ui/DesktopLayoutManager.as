package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1044:String = "room_view";
      
      private var var_53:IWindowContainer;
      
      private var var_644:int = 50;
      
      private var var_2291:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_53.getChildByTag(const_1044) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_53.findChildByTag(const_1044) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_644;
               _loc2_.width = var_53.desktop.width - var_644;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_644;
               _loc2_.height = var_53.desktop.height - var_644;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_53.desktop.width;
