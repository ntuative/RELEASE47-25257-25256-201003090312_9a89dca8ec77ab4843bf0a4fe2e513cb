   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_462 != null)
         {
            ...
            {
               _loc2_ = var_462.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_462.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_653.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_462.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_653.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_547,RoomWidgetChatSelectAvatarMessage.const_512];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_547:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_157,_container.roomSession,0,"Version 25257-25256-201003090241");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_512:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_804 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_804);
            }
            if(var_463 == null)
            {
               var_461.x = 0;
               var_461.y = 0;
               var_461.z = 0;
               var_463 = _loc4_.getScreenPoint(var_461);
               var_804 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_461.x = 0;
