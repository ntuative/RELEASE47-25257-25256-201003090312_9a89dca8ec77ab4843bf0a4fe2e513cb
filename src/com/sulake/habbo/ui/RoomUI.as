package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_892:IRoomWidgetFactory;
      ...
      private var var_345:ISessionDataManager;
      ...
      private var var_893:IHabboHelp;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_892;
         _loc3_.sessionDataManager = var_345;
         ...
         _loc3_.avatarEditor = var_1310;
         _loc3_.catalog = _catalog;
         _loc3_.adManager = var_272;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_893;
         _loc3_.moderation = var_732;
         _loc3_.config = _config;
         _loc3_.soundManager = var_521;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_521 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               if(param1.session != null)
               {
                  ...
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.ZOOM));
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.MEMENU));
                  var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_180,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_272.events.addEventListener(AdEvent.const_355,adEventHandler);
            var_272.events.addEventListener(AdEvent.const_459,adEventHandler);
            var_272.events.addEventListener(AdEvent.const_371,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_892 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_892 != null)
         {
            var_892.release(new IIDHabboRoomWidget());
            var_892 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_521 != null)
         {
            var_521.release(new IIDHabboSoundManager());
            var_521 = null;
         }
         if(var_272 != null)
         {
         ...
         if(var_893 != null)
         {
            var_893.release(new IIDHabboHelp());
            var_893 = null;
         }
         ...
         if(var_732 != null)
         {
            var_732.release(new IIDHabboModeration());
            var_732 = null;
         }
         if(_navigator != null)
         {
         ...
         if(var_345 != null)
         {
            var_345.release(new IIDSessionDataManager());
            var_345 = null;
         }
         var_1310 = null;
         _connection = null;
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_732 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_732);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_345 = param2 as ISessionDataManager;
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_538:
               ...
               if(var_1552 != RoomDesktop.const_517)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_239,var_1552);
               }
               if(var_272 != null)
               {
                  var_272.showRoomAd();
            ...
            case RoomEngineEvent.const_553:
               ...
               break;
            case RoomEngineRoomColorEvent.const_707:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_596,roomEngineEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_707,roomEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_20)
         {
            var_20.events.addEventListener(RoomSessionEvent.const_285,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionEvent.const_90,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionEvent.const_103,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionChatEvent.const_157,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionUserBadgesEvent.const_108,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_104,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_110,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_55,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPresentEvent.const_242,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_229,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_210,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_570,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_962,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_943,roomSessionDialogEventHandler);
            ...
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_201,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_207,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_228,roomSessionDialogEventHandler);
            ...
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_618,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_159,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_646,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_734,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionQueueEvent.const_368,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionVoteEvent.const_114,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionVoteEvent.const_119,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_126,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_63,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_121,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDimmerPresetsEvent.const_392,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionFriendRequestEvent.const_118,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_596)
         {
            if(var_20 != null)
            {
               var_20.roomEngineReady = true;
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1310 = param2 as IHabboAvatarEditor;
      }
   }
}
