package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_567,RoomWidgetStickieSendUpdateMessage.const_573,RoomWidgetStickieSendUpdateMessage.const_458];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_567:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_920);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
            ...
            case RoomWidgetStickieSendUpdateMessage.const_458:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_573:
