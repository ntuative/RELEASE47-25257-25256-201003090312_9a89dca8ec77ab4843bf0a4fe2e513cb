package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_655,_data.flatId),var_52,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1340,_loc2_,var_378.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_959.isSelected,var_958.isSelected,var_638.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1210);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1271);
      }
      ...
      public function populate() : void
      {
         ...
         var_638 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_959 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_958 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
