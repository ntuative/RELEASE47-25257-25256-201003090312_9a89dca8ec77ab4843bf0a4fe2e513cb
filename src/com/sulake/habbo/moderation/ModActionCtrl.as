package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_766:IButtonWindow;
      
      private var var_1122:int;
      
      private var _main:ModerationManager;
      
      private var var_629:OffenceCategoryData;
      
      private var var_378:ITextFieldWindow;
      
      private var var_765:IButtonWindow;
      ...
      private var var_630:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_766 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_765 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_764.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1122,var_378.text,getBanLength(),var_1123));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_764.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1122,var_378.text,var_1123));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_629 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1122,var_378.text,var_1123));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_629 != null;
         if(this.var_630 != null)
         {
            var_52.findChildByName("offence_txt").caption = this.var_630.name;
            var_52.findChildByName("offence_category").visible = true;
         }
         else if(this.var_629 != null)
         {
            this.refreshButtons("offences_cont",2,var_629.offences,var_766,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_765,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_630 = var_629.offences[_loc3_];
         var_378.text = var_630.msg;
         var_290 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_52.caption = "Mod action on: " + var_1394;
         ...
         var_764 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_764);
