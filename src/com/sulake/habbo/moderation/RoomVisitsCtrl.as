package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2107.clone());
         ...
         new OpenRoomTool(var_52,_main,_loc5_,param1.method_7,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(_main,_loc7_,param1.method_7,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_2107 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
