package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.releaseBundle(var_114.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_425 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_1052 = new UserInfoCtrl(_window,var_60,_loc3_.message);
         var_425.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_114.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1052.load(_loc4_,var_114.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_114.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_60,WindowTracker.const_904,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_60 != null && false && var_114 != null)
         {
            var_60.issueManager.removeHandler(var_114.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_114.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_60.issueManager.closeBundle(var_114.id,3);
         checkAutoHandling();
         dispose();
      }
