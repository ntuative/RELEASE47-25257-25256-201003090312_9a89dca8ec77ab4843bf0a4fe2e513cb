package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_361:HabboCommunicationDemo;
      ...
      {
         var_361.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_361.shockwaveClientUrl = var_117.shockwaveClientUrl;
         var_361.ssoTicket = var_117.ticket;
         var_117.removeEventListener(SSOTicket.const_310,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_276,onParsedTicketFailure);
         var_117 = null;
      ...
      {
         var _loc1_:XmlAsset = (var_361 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_361.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_429,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_361.windowManager.buildFromXML(_loc2_) as IWindowContainer;
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_361.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_361.habboCommunication.habboWebLogin(name,password);
         var_117 = new SSOTicket(var_361.assets,_loc2_,_loc1_);
         var_117.addEventListener(SSOTicket.const_310,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_276,onParsedTicketFailure);
      }
