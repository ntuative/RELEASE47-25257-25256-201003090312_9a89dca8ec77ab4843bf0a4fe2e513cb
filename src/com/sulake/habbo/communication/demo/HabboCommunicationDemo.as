package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1998:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1508:ILogger;
      ...
      private var var_406:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_289:
            ...
            case DisconnectReasonEvent.const_844:
               ...
               break;
            case DisconnectReasonEvent.const_789:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_1013:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1999)
         {
            _loc2_ = _habboConfiguration.getKey("logout.disconnect.url");
            if(_habboConfiguration.method_4("facebook.user"))
            {
      ...
      {
         var_1011 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_231);
         param1.send(new VersionCheckMessageComposer(401,var_1265,var_1997));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_406.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_406.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1998);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1265 = _habboConfiguration.getKey("flash.client.url","");
         var_1997 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_171 == null)
         {
         ...
         if(var_692 != null)
         {
            var_70.mode = HabboConnectionType.const_419;
            var_70.initConnection(HabboConnectionType.const_245);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1508 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_540);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1998 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_70.mode)
         {
            case HabboConnectionType.const_419:
               ...
               var_1012 = _loc4_;
               var_171.loadBannerImage(_loc7_ + "?token=" + var_1012,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1334:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1234:
               var_693 = generateRandomHexString(30);
               var_406 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_406.init(var_693);
               _loc8_ = var_406.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1012);
         ...
         var_406 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_406.init(_loc14_);
            _loc15_ = var_406.getPublicKey(10);
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_103,onRoomSessionEnded);
      }
