package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_817:IRoomSession;
      ...
      private var var_984:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_20 != null)
         {
            ...
            var_20.events.removeEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_420,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               var_817 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_420:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_634));
      }
      ...
      {
         var_161.clubPeriods = param1;
         var_161.clubDays = param2;
         var_161.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_142));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_827));
      }
      ...
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_304));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_816.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_816.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_244));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_345 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_816.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_161.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_47.getValue(InventoryCategory.const_479) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_984 = new IncomingMessages(this);
      ...
      {
         return var_161.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_161.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_271));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_103,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_420,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_479,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_345);
         var_47.add(InventoryCategory.const_271,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_634,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_345);
         var_47.add(InventoryCategory.const_304,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_244,_loc8_);
         ...
         var_47.add(InventoryCategory.const_142,_loc10_);
