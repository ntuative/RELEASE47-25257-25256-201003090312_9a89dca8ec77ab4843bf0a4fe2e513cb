package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1076:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_94 = var_607.height;
         var_1077 = param5;
         var_908 = param6;
         var_239 = Math.floor(var_1077 / _thumbWidth);
         var_21 = new BitmapData(var_1077,var_908);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_239 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_239 - param1.x - 1;
         ...
         if(param1.y < var_517 - 1)
         {
            ...
            var_21.fillRect(new Rectangle(0,0 - var_94,var_21.width,var_94),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == var_239 - 1)
            {
               _loc11_ = new BitmapData(var_21.width,0 - var_94);
               _loc2_ = new Rectangle(0,0,var_21.width,0 - var_94);
               _loc11_.copyPixels(var_21,_loc2_,new Point(0,0),null,null,true);
               var_21 = _loc11_;
               --var_517;
            }
         }
         if(var_21.height < var_908)
         {
            _loc12_ = new BitmapData(var_21.width,var_908);
      ...
      private function getList() : Array
      {
         ...
         if(var_1076 != null)
         {
            _loc1_ = var_1076.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_517 = resolveRowCountFromList();
         if(var_517 == 0)
         {
            var_21 = new BitmapData(var_1077,var_908);
            return;
         }
         var_21 = new BitmapData(Math.max(var_239 * _thumbWidth,var_1077),Math.max(var_517 * var_94,var_908),true,16777215);
         var_21.fillRect(var_21.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_517)
         {
            _loc4_ = 0;
            while(_loc4_ < var_239)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_21.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_94),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_239 && var_21.height < _loc3_.y * var_94)
         {
            _loc2_ = new BitmapData(var_21.width,var_21.height + var_94);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_239 - 1),var_94);
         _loc2_.copyPixels(var_21,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_239 - 1),0,_thumbWidth,var_21.height);
         _loc2_.copyPixels(var_21,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_239 - 1),0 - var_94);
         _loc2_.copyPixels(var_21,_loc4_,new Point(_thumbWidth,var_94),null,null,true);
         var_21 = _loc2_;
      }
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_239));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_239);
         var _loc3_:int = param1 % var_239;
         return new Point(_loc3_,_loc2_);
      }
