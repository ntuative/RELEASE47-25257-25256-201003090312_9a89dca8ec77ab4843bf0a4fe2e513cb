package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_10 = param1;
         var_28 = var_10.communication;
         var_28.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_28.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_28.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_28.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_28.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_28.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_28.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_28.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_28.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_28.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_28.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_28.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_28.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_28.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_28.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_28.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_28.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_28.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_28.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_28.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_28.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_28.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_28.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_28.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_28.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_28.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_28.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_28.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_28.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_28.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_28.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_28.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_28.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_28.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_28.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_28.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_28.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_28.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_634);
         _loc2_.refreshViews();
         var_10.notifyChangedEffects();
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_28.getHabboMainConnection(null);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_10.toggleInventorySubPage(InventorySubCategory.const_244);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_10.setInventoryCategoryInit(InventoryCategory.const_271);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_10.setInventoryCategoryInit(InventoryCategory.const_479);
         var _loc4_:FurniModel = var_10.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
