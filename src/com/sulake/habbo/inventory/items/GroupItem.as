package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1411:Number = 0.2;
      
      protected var var_1369:Boolean;
      
      private const const_1412:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_583)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1456));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1369 && getRecyclableCount() > 0)
            {
