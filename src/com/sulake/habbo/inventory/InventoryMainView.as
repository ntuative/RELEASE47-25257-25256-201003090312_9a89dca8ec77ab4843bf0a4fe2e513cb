package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1176);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_657 == InventoryCategory.const_142)
            {
               toggleCategoryView(InventoryCategory.const_142);
            }
            else if(var_657 == InventoryCategory.const_76)
            {
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_544,HabboToolbarIconEnum.INVENTORY,var_14 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_13.inventoryViewOpened(var_656);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_657 || !var_13.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_187 != null && var_805)
