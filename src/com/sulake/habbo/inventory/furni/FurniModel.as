package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1057:int = 100;
      
      public static const const_335:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_471 = new Timer(const_1057,1);
      ...
      {
         return var_13.getSubCategoryViewId() == InventorySubCategory.const_244;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_583)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_673 == null)
         {
            var_673 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_673.clone() as IWindowContainer;
      ...
      {
         var_13.checkCategoryInitilization(InventoryCategory.const_479);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_335:
                  var_13.toggleInventoryPage(InventoryCategory.const_142);
            }
         }
      }
      ...
      {
         if(var_822 && param1.type == RoomEngineObjectEvent.const_212)
         {
            var_13.showView();
            var_822 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_286 || _loc3_.category == FurniCategory.const_334 || _loc3_.category == FurniCategory.const_331)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_389 = new Map();
         var_389.add(const_42,new Array());
         var_389.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
