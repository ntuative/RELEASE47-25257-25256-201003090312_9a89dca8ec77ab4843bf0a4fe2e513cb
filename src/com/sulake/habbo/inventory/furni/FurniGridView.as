package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         return var_446.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            _model.toggleItemSelection(_category,var_446.getGridItemIndex(param1.window));
            var_328 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_29 && var_328 != null && var_328 == param2 && true)
         {
