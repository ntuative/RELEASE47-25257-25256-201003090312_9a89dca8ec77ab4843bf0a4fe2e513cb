package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      {
         if(var_586 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_586.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_586.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_586.getValue(param1.id) != null)
         {
            return;
         }
