package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      {
         if(var_36 == RoomSessionEvent.const_285 && _connection != null)
         {
      ...
      public function method_9(param1:Boolean) : void
      {
         if(param1)
         {
      ...
      {
         return var_1015 as IUserDataManager;
      }
