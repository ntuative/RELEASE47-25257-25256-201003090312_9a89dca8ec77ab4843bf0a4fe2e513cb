package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1084:String = "badges";
      
      private static const const_1087:String = "pet_inventory";
      
      private static const const_1083:String = "pixelbalance";
      
      private static const const_1086:String = "credits";
      
      private static const const_1080:String = "inventory";
      
      private static const const_1085:String = "friendlist";
      
      private static const const_1081:String = "selectfurni";
      
      private static const const_1082:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_579:ParkBusDialogManager;
      
      private var var_580:IHabboToolbar;
      ...
      private var var_694:ClubGiftNotification;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1316);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_694 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_867)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1159);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2000)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_809);
            var_2000 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_580)
         {
            var_580.release(new IIDHabboToolbar());
            var_580 = null;
         }
         if(_windowManager)
         {
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_809,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_543.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_913,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_163 || param2.type == WindowEvent.const_515)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_407.isSpaceAvailable() && false)
         {
            var_407.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_579 == null)
         {
            var_579 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_579 != null)
         {
            var_579.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1013.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_543.createPetImage(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_345);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc15_ = var_345.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_81)
               {
                  _loc15_ = var_345.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_345.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1326,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_543.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      {
         var_580 = IHabboToolbar(param2);
         var_580.events.addEventListener(HabboToolbarEvent.const_87,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_345.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_948);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_948);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_87)
         {
            ...
            var_407 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_851["styles"],var_851["view"],var_580);
            ...
            registerUpdateReceiver(var_407,1);
            registerUpdateReceiver(this,2);
            var_345.events.addEventListener(BadgeImageReadyEvent.const_124,onBadgeImage);
            var_580.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
