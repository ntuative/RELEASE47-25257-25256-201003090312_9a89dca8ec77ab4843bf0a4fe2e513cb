package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_2026 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_200);
         setImage("badge_image",param7.getBadgeImage(param1));
         if(!param6.method_4("facebook.user"))
         {
      ...
      public function dispose() : void
      {
         if(var_345 != null)
         {
            var_345.events.removeEventListener(BadgeImageReadyEvent.const_124,onBadgeImageReady);
            var_345 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_702,var_2026);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_702,var_702));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_702,var_702));
         _localizations.registerParameter(param1,"level",var_1731.toString());
         _localizations.registerParameter(param1,"name",var_345.userName);
         _localizations.registerParameter(param1,"realname",var_345.realName);
      }
   }
}
