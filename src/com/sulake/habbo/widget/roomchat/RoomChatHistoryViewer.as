package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_159.state = RoomChatHistoryPulldown.const_222;
         ...
         var_45 = param2.createWindow("chatscroller","",HabboWindowType.const_804,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_235 > 0 && param2)
         {
            if(var_1309)
            {
               if(Math.abs(param1 - var_235) <= const_842)
               {
                  return;
               }
               var_1309 = false;
            ...
            if(var_312)
            {
               ...
               _loc3_ = var_358 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_235;
               _loc7_ = true;
               _loc8_ = true;
               if(var_45.scrollV < 1 - const_1108 / var_45.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1551)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_312 && !var_1266)
         {
            ...
            var_159.state = RoomChatHistoryPulldown.const_316;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_159.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_222);
      }
