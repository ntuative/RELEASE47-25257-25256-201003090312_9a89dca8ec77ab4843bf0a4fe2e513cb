package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      {
         _widget.onItemMouseOut(var_1071,var_1072,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1071,var_736,var_1072,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1331 = param1.chatType;
         var_1071 = param1.userId;
         var_736 = param1.userName;
         var_1072 = param1.userCategory;
         _message = param1.text;
         var_1332 = param1.userX;
         var_201 = param1.userImage;
         var_1073 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_201 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_430 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1073 != 0)
            {
               _loc30_ = uint(var_1073 >> 16 & 255);
               _loc31_ = uint(var_1073 >> 8 & 255);
               _loc32_ = uint(var_1073 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1331 == RoomWidgetChatUpdateEvent.const_259)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_736);
            }
            else if(var_1331 == RoomWidgetChatUpdateEvent.const_251)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_736);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_348 + _loc20_.textWidth + const_495;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1071,var_1072,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1071,var_1072,_roomId,_roomCategory,param1);
      }
