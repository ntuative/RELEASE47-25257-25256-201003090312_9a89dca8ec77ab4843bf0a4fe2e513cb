package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1618:String = "level";
      ...
      private const const_1614:String = "nutrition";
      ...
      private const const_1615:int = 16;
      ...
      private const const_1617:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_234 != null)
         {
            var_104 = var_234.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_104 == null || var_234 == null || var_61 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1115.getValue(var_718) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1618,param1.level,param1.levelMax);
         updateStateElement(const_1617,param1.experience,param1.experienceMax);
         updateStateElement(const_1616,param1.energy,param1.energyMax);
         updateStateElement(const_1614,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_718 = param1.id;
         var_1115.remove(param1.id);
         var_1115.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_450,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1611,const_1615,false);
