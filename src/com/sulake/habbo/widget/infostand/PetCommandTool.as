package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      {
         var_1023.remove(param1);
         var_1023.add(param1,param2);
         if(param1 != var_718)
         {
            return;
         }
      ...
      {
         var _loc2_:Array = var_1023.getValue(var_718) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_353,var_718));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_519,var_718,var_2071 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_1023.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
      ...
      private function createCommandWindow() : void
      {
         ...
         var_43.setParamFlag(WindowParam.const_89,true);
