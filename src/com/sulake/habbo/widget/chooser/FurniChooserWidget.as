package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_496:ChooserView;
      ...
      {
         if(var_496 == null || !var_496.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_496 == null)
         {
            var_496 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_496.populate(param1.items,param1.isAnyRoomController);
      }
