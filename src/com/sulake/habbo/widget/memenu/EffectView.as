package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_789:IWindow;
      
      private var var_414:Number;
      
      private var var_788:ITextWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_789 = _window.findChildByName("effect_hilite");
            var_789.visible = false;
         }
         var_788 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_787 = _window.findChildByName("loader_bar");
         if(var_787 != null)
         {
            var_414 = var_787.width;
            var_167.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_788 != null)
         {
            var_788.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_788.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
