package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_907:MeMenuSettingsView;
      
      private var var_2367:int;
      
      private var var_568:BitmapData;
      
      private var var_994:Number = 1;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_907.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_568 != null)
            {
               ...
               var_1473 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1473 * (Number(param1 - var_674) / (var_994 - var_674)));
      }
      ...
      {
         return param1 / var_1473 * (var_994 - var_674) + var_674;
      }
   }
}
