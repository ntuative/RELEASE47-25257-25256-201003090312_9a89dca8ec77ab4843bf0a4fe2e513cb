      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_973);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1003));
            ...
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_710);
               break;
            case "news":
               if(false && false)
               {
