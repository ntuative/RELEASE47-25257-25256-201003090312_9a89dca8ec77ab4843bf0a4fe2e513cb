package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_97 && param1.type != WindowMouseEvent.const_469)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1473 * (var_994 - var_674)) + var_674;
      }
   }
}
