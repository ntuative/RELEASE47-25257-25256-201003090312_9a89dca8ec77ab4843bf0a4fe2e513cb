package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1089,const_1088,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_350 != null)
         {
            var_350.setValue(var_1024);
         }
         var_429 = colors.indexOf(_loc2_.color);
         if(var_491 != null)
         {
            var_491.setSelectedColorIndex(var_429);
         }
