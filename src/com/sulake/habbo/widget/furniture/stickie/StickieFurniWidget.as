package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1088:Number = 100;
      
      private static const const_1112:int = 500;
      
      private static const const_1089:Number = 100;
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_458,var_160,var_200,var_734);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_573,var_160);
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_458,var_160,var_200,var_734);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1089,const_1088,2,2),null,0) as IWindowContainer;
         ...
         {
            _loc3_.text = var_200;
            _loc3_.addEventListener(WindowEvent.const_147,onTextWindowEvent);
         }
         _loc6_ = _window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(var_1557 == "post_it_vd")
            {
         ...
         setColorButtons(var_13 && var_1557 == "post_it");
      }
