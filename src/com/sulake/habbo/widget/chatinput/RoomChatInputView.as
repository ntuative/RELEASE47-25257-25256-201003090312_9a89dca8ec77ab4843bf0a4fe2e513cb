package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2250 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2252 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_147,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2251 = _loc2_.width + const_495 + _loc6_.width + const_1136;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1137,_loc8_.width) + const_495);
            _loc8_.x = _loc12_;
