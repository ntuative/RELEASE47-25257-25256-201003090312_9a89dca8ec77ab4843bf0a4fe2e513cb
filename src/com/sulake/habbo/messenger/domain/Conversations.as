package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1327:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_590,0,var_427.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         return new Message(Message.const_643,0,getOnlineText(param1),Util.getFormattedNow());
      }
