package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_169 ? var_129.conversations.findConversation(param2.id) : var_129.conversations.openConversations[_loc3_ + var_129.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
