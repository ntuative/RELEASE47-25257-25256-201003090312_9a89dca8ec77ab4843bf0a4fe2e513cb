package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1092:String = const_344;
      ...
      public static const const_520:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_488 = [];
         var_487 = [];
         var_2032 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2033 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_409 = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_128 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_172 != null && var_172.hasWorldType(const_279 + param1))
         {
            return var_172.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_487.indexOf(_loc14_) < 0)
                              {
                                 var_487.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_409 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_409.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_409.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_409.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_344,const_490,ROOM_CONTENT,const_771,const_769];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2032.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_164 && _loc5_ != RoomObjectLogicEnum.const_128)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1368);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2027)
         {
            ...
            if(var_1021 != null)
            {
               var_1021.dispatchEvent(new Event(const_520));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_172 != null)
         {
            return var_172.getWorldHeightScale(const_279 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1021 = param1;
            var_2030 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2029 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2031 = param2.getKey("public.room.dynamic.download.url","");
            var_2028 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_36 = const_770;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_164 && _loc5_ != RoomObjectVisualizationEnum.const_128)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_381.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_279 + param1) == RoomObjectCategoryEnum.const_62)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1281.getValue(param1) != null)
         {
            var_172 = var_1281.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_451,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_172 != null)
         {
            return var_172.getWorldScale(const_279 + param1);
         }
         return 32;
      }
