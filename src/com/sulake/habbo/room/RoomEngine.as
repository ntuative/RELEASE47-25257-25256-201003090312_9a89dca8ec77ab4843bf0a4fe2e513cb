package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_754:String = "overlay";
      ...
      private var var_381:IRoomObjectVisualizationFactory = null;
      ...
      private var var_666:RoomMessageHandler = null;
      
      private var var_665:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_666 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_111,var_112,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_636) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_606) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_533) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_527) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_30)
            {
               return var_65.modifyWallItemData(var_111,var_112,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_381 != null)
         {
            var_381.release(new IIDRoomObjectVisualizationFactory());
            var_381 = null;
         }
         if(var_42 != null)
         {
         ...
         if(var_665 != null)
         {
            var_665.release(new IIDRoomRendererFactory());
            var_665 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_724);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_612);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_545);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_958);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_997);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1021) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_793);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_605,var_111,var_112,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_111,var_112,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_685,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_111,var_112);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_300,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_312,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_885,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_916,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_939,getTimer());
         }
      ...
      {
         if(var_29 == null || var_381 == null || var_42 == null || var_665 == null || _communication == null || _habboConfiguration == null || !var_1849)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_277,RoomObjectCategoryEnum.const_62);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_111,var_112));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1198);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1198);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_381 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_381;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_29 != null)
         {
            if(false)
            {
               var_29.events.addEventListener(RoomObjectMouseEvent.const_217,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.const_407,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_254,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectStateChangeEvent.const_649,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectWidgetRequestEvent.const_132,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_410,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_416,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_403,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_444,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_438,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_448,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectFurnitureActionEvent.const_385,roomObjectEventHandler);
               ...
               var_29.events.addEventListener(RoomObjectMoveEvent.const_435,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectMoveEvent.const_359,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_260,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_472,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_325,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomAdEvent.const_338,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_476,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_927,roomObjectEventHandler);
               var_29.events.addEventListener(RoomObjectRoomActionEvent.const_426,roomObjectEventHandler);
               var_29.events.addEventListener(AvatarWalkWarpingWarningEvent.const_436,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_600) != 0)
         {
            return false;
         }
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_111,var_112,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_467 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_596,0,0));
            _loc2_ = 0;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_520)
         {
            var_1849 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_300,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_312,_loc11_,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_270,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_371,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_754) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_665 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_42.getRoom(const_485);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_485,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
            ...
            case RoomObjectCategoryEnum.const_62:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_237,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_674,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_542,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_500,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_475,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_983.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_817,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.y = var_1458 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_408,var_111,var_112,-1,RoomObjectCategoryEnum.const_194));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_277,const_484);
                  var_65.handleRoomObjectEvent(_loc14_,var_111,var_112);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_112,var_1198);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.y = var_1458 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_871,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_979,RoomObjectVariableEnum.const_293,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_520,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_111,var_112);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_485);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_817);
               ...
               _loc13_ = var_983.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_111,var_112,const_277,RoomObjectCategoryEnum.const_62,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_600,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_938,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_277,const_484,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_600,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_724,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_636,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_533,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_606,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_527,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1017,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_685,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_475,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_225);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_612,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_545,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_612,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_545,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_958,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_997,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_755,const_1056,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
