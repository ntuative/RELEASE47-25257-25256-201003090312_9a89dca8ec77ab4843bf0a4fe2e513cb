         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc5_ = _loc2_.getString(RoomObjectVariableEnum.const_171);
                  _loc2_.setString(RoomObjectVariableEnum.const_171,_loc4_.figure);
                  _loc2_.setString(RoomObjectVariableEnum.const_1255,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_366,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_455,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc9_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_620,_loc9_.numberOfWords);
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_966,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_931,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
