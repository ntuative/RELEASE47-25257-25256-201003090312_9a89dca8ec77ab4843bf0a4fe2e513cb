package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1572:int = 1500;
      
      private var var_1574:int = 255;
      
      private var var_1573:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_905,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_887,int(_loc5_.bgOnly));
            var_1340 = _color;
            var_1574 = var_1218;
            var_1080 = _loc11_;
            var_1573 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_859,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_501,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1287,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1187,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1258,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_152 || _loc13_ == RoomPlaneData.const_237)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_911)
         {
            ...
            {
               _loc7_ = var_1340 >> 16 & 255;
               _loc8_ = var_1340 >> 8 & 255;
               _loc9_ = var_1340 & 255;
               _loc10_ = var_1080 >> 16 & 255;
               _loc11_ = var_1080 >> 8 & 255;
               _loc12_ = var_1080 & 255;
               _loc13_ = (_loc2_ - var_911) / var_1572;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1574 + (var_1573 - var_1574) * _loc13_;
               _color = _loc3_;
               var_1218 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_501,_loc3_);
         }
      }
   }
}
