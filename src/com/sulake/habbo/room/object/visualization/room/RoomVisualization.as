package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1065:int = 16777215;
      
      public static const const_1291:int = 10066329;
      
      private static const const_1062:int = 13421772;
      
      public static const const_1257:int = 16777215;
      
      private static const const_1410:int = 0;
      
      public static const const_1361:int = 16777215;
      
      private static const const_1064:int = 10066329;
      
      private static const const_1063:int = 10066329;
      
      public static const const_1221:int = 13421772;
      ...
      private var var_1757:int = -1000;
      
      private var var_991:uint = 16777215;
      ...
      private var var_1892:String = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         _data.method_3(assetCollection);
         return true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_859);
         ...
         while(_loc7_ < var_77.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_240,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_187,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_240 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
         ...
         while(_loc5_ < var_391.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_106.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_240 || _loc3_.type == RoomPlane.const_187 && _loc8_ == RoomPlaneBitmapMaskData.const_225)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        if(var_77.getPlaneType(_loc9_) == RoomPlaneData.const_155)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1138)
         {
            var_1138 = param1.updateId;
            var_565 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_955 || _loc9_.y != var_1701 || _loc9_.z != var_1697 || param1.scale != var_1699))
            {
               var_955 = _loc9_.x;
               var_1701 = _loc9_.y;
               var_1697 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_905);
            if(_loc10_ != var_1892)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_501));
            if(_loc11_ != var_991)
            {
               var_991 = _loc11_;
               var_1893 = var_991 & 255;
               var_1894 = var_991 >> 8 & 255;
               var_1890 = var_991 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1757 + const_1630 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1757 = _loc7_;
         if(var_164 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_542);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_674);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_500);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1891 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_887));
         ...
         while(_loc8_ < var_390.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_187)
            {
               if(var_1891)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1893 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1894 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1890 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_106.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_240 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_187 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
