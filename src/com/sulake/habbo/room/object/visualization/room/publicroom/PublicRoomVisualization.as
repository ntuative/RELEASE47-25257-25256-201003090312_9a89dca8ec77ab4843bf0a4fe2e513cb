   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(data != null)
         {
            ...
            {
               data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + var_1102));
               _loc4_++;
            }
            data.layoutRasterizer.initializeAds(var_1102,this);
         }
         var_1989 = true;
      }
