package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_501:Boolean = true;
      
      private var _adBgIndex:int = -1;
      
      private var var_838:IGraphicAssetCollection;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1051 = param1;
         var _loc3_:LayoutRasterizerData = var_44.getValue(var_728);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1305 = RoomObjectVariableEnum.const_919;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1305 = RoomObjectVariableEnum.const_871;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1305);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_467;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2122);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_728)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1049 = var_44.getValue(var_728);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_44.getValue(var_728);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = var_838.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_355.indexOf(_loc10_) >= 0 && var_501)
            {
               param1 = var_355.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_838.getAsset(var_499[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
