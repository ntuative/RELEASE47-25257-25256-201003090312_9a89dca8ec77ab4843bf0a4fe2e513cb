package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2346:int = 69069;
      
      private var var_1297:int = 1;
      
      private var var_2345:int = 5;
      
      private var var_1537:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1537 * param2);
      }
      ...
      {
         var _loc1_:int = var_2346 * var_1297 + var_2345;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
