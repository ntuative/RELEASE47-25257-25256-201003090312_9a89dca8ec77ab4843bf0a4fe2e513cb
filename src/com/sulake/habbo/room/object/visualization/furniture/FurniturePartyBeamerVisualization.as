package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_974[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_975[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_974 = new Array();
         var_974.push(Math.random() * _loc2_ * 1.5);
         var_974.push(Math.random() * _loc2_ * 1.5);
         var_973 = new Array();
         var_973.push(1);
         var_973.push(-1);
         var_976 = new Array();
         var_976.push(const_1047);
         var_976.push(const_1048);
         var_975 = new Array();
         var_975.push(getRandomAmplitudeFactor());
         var_975.push(getRandomAmplitudeFactor());
      }
