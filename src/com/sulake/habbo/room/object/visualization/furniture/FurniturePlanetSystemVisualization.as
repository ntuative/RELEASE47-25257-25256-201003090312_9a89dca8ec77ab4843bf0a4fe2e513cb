package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_799);
      ...
      {
         if(param1 < var_570.length)
         {
            return var_570[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_221 != null)
         {
            ...
            {
               _loc2_ = var_221[_loc3_];
               _loc2_.update(var_570,var_1913,param1);
               _loc3_++;
            }
