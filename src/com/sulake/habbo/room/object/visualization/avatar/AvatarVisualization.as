package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1413:int = 0;
      
      private var var_609:String;
      
      private var var_625:int = 0;
      
      private const const_1633:int = 1;
      ...
      private const const_1074:int = 3;
      
      private const const_1632:int = 2;
      
      private var var_843:AvatarVisualizationData = null;
      ...
      {
         var_843 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_437.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_171);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_620);
         ...
         var _loc14_:Number = _loc8_ - var_1246;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_295);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_288 != _loc3_.getUpdateID() || var_208 != param1.scale || var_164 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_478 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_478;
            ...
            if(var_609 != _loc7_)
            {
               for each(_loc49_ in var_437.getKeys())
               {
                  var_437.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_843.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_437.remove(_loc5_);
               var_437.add(_loc5_,_loc6_);
               var_609 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_313);
            ...
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_585);
            _loc6_.appendAction(AvatarAction.const_531,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_366);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_52)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_455);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_303,AvatarAction.const_1260[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_963);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_840,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_830);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_795);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_893,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_717);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_709);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_868,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_813);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_797,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_409);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_393) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_588);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_478);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_936);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_584,_loc36_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.include))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_843.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_844.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_844)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_437 != null)
         {
            _loc1_ = var_437.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_437.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
