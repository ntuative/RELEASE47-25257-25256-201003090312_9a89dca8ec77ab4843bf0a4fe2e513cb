package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1043:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_877 = new Array();
         var_2323 = new Array();
         var_1043 = new ToolbarIconBouncer(0.8,1);
         super();
         var_495 = param1;
         ...
         _events = param5;
         var_269 = param6;
         var_1296 = new Timer(40,40);
         var_1296.addEventListener(TimerEvent.TIMER,updateBouncer);
         var_98 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_447,HabboWindowStyle.const_41,HabboWindowParam.const_40,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1536[var_1044.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_269)
               {
                  var_269.repositionWindow(var_724,true);
               }
               if(_events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_57);
                  _loc4_.iconId = var_724;
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_877[var_596.indexOf(param1)];
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_269 != null)
         {
            var_269.animateWindowIn(this,param1,param2,var_724,param3,param4,getMenuYieldList(param1));
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_2110 = int(param1.@window_margin);
         var _loc2_:XMLList = param1.elements("state");
         if(_loc2_.length() > 0)
         {
            if(param1.attribute("state_over").length() > 0)
            {
               var_1042 = param1.@state_over;
            }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.hideWindow(param1,param2,var_724,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_269 != null)
         {
            var_269.positionWindow(this,param1,param2,var_724,param3,getMenuYieldList(param1));
         }
      }
      ...
      {
         if(var_1043 != null && _window != null)
         {
            var_1043.update();
            _window.y = var_1043.location;
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && var_1041)
         {
            ...
            var_418 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_83,_y,_bitmapData);
            if(false)
            {
               var_723 = new Timer(_loc1_.timer);
               var_723.addEventListener(TimerEvent.TIMER,updateAnimator);
               var_723.start();
            }
            if(_loc1_.bounce)
            {
      ...
      {
         return var_2110 + var_495.windowMargin;
      }
