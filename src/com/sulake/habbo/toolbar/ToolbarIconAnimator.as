package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_810 = new Array();
         var_36 = param1.id;
         var_1163 = param1.nextState;
         var_1191 = param1.loop;
         if(param1.background != null)
         {
            var_811 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_809.push(new XML());
               var_810.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_810[var_52] = param6.clone();
         }
      ...
      {
         return var_809.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1191 == false && var_663 == 1 && var_1163 != var_36;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_811 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_811.width),Math.max(param2.height,var_811.height));
            _loc3_.copyPixels(var_811,var_811.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_52 <= var_810.length)
         {
            _loc2_ = var_810[var_52];
