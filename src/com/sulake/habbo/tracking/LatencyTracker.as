package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1478 = getTimer();
         var_474.add(var_1226,var_1478);
         _connection.send(new LatencyPingRequestMessageComposer(var_1226));
         ++var_1226;
      }
      ...
      public function init() : void
      {
         ...
         var_1479 = int(var_149.getKey("latencytest.interval"));
         var_1480 = int(var_149.getKey("latencytest.report.index"));
         var_1932 = int(var_149.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_151.push(_loc4_);
         if(var_151.length == var_1480 && var_1480 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1481) > var_1932 || var_1481 == 0)
            {
               var_1481 = _loc9_;
