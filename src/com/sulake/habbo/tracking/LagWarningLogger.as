package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1149 || var_1521 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1522 == 0 || _loc1_ - var_1522 > var_1521)
         {
            if(_connection != null)
            {
      ...
      {
         var_1149 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1521 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
