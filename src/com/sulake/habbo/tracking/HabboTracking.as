package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_212:PerformanceTracker = null;
      ...
      private var var_797:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_212 = new PerformanceTracker();
         var_213 = new LatencyTracker();
         var_798 = new LagWarningLogger();
         var_1166 = new Array(const_749);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1163,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1181,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1225,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_592,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               method_1(HabboLoginTrackingStep.const_1383);
               break;
            case HabboCommunicationEvent.const_540:
               method_1(HabboLoginTrackingStep.const_1203,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_231:
               method_1(HabboLoginTrackingStep.const_231);
               break;
            case HabboCommunicationEvent.const_160:
               method_1(HabboLoginTrackingStep.const_160);
               break;
            case HabboCommunicationEvent.const_179:
               setErrorContextFlag(2,0);
               method_1(HabboLoginTrackingStep.const_179);
               break;
            case HabboCommunicationEvent.const_224:
               setErrorContextFlag(3,0);
               method_1(HabboLoginTrackingStep.const_224);
               if(var_213 != null)
               {
                  var_213.init();
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_149)
         {
            Component(var_149).events.addEventListener(HabboConfigurationEvent.const_170,onConfigurationLoaded);
            if(var_213 != null)
            {
               var_213.configuration = var_149;
            }
            if(var_212 != null)
            {
               var_212.configuration = var_149;
            }
            if(var_798 != null)
            {
               var_798.configure(var_149);
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_272.events.addEventListener(AdEvent.const_371,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1797)
         {
            method_1(HabboLoginTrackingStep.const_1253);
            var_1797 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_592,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_540,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_231,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_560,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_436:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_797)
            {
               var_797.release(new IIDHabboWindowManager());
               var_797 = null;
            }
            if(var_272)
            {
            ...
            if(var_169)
            {
               if(true)
               {
                  ...
                  Component(var_169).events.removeEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
               }
            ...
            if(var_138)
            {
               if(true)
               {
                  var_138.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_138.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_138.release(new IIDHabboHelp());
               var_138 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_436,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         method_1(HabboLoginTrackingStep.const_170);
         if(var_149)
         {
            Component(var_149).events.removeEventListener(HabboConfigurationEvent.const_170,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         method_1(HabboLoginTrackingStep.const_94);
         if(_localization)
         {
      ...
      {
         var_138 = param2 as IHabboHelp;
         var_138.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_138.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         method_1(HabboLoginTrackingStep.const_949);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_949,onCoreRunning);
         }
      }
      ...
      {
         var_797 = IHabboWindowManager(param2);
         if(var_797)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_436,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_169).events.addEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_149)
            {
               if(var_149.method_4("client.fatal.error.url"))
               {
                  ...
                  if(var_212 != null)
                  {
                     _loc4_["null"] = var_212.flashVersion;
                     _loc4_["null"] = var_212.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_560)
         {
            method_1(HabboLoginTrackingStep.const_1171);
         }
         else if(param1.type == HabboHotelViewEvent.const_439)
         {
            method_1(HabboLoginTrackingStep.const_1378);
         }
         else if(param1.type == HabboHotelViewEvent.const_63)
         {
            method_1(HabboLoginTrackingStep.const_1194);
         }
      }
   }
}
