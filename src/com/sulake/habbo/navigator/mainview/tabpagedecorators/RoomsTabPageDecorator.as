package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_268,Tabs.const_324);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_268,Tabs.const_639);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_268,Tabs.const_324,"" + _loc3_);
         }
      }
