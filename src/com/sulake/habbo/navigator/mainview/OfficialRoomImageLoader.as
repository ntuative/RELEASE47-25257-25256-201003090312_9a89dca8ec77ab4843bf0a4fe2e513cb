package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private var var_748:IBitmapWrapperWindow;
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         Logger.log("IMAGE READY: " + var_921 + ", " + _loc2_);
         setImage();
      }
      ...
      public function startLoad() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(_navigator.assets.hasAsset(var_921))
         {
            setImage();
         }
         else
         {
            ...
            _loc2_ = _navigator.assets.loadAssetFromFile(var_921,_loc1_,"image/gif");
      ...
      {
         var _loc1_:BitmapData = _navigator.getButtonImage(var_921,"");
         var_748.bitmap = _loc1_;
         var_748.width = _loc1_.width;
         var_748.height = _loc1_.height;
         var_748.visible = true;
         dispose();
      }
   }
}
