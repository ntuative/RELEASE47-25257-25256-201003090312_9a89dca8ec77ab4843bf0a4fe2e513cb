package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      {
         refreshTextWithCaption("roomowner",var_165,var_109.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_901.refreshTags(_loc1_,var_109.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1626.refreshThumbnail(_loc1_,var_109.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_165,var_109);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_165,!true ? getEventCtg(var_109.categoryId) : getRoomCtg(var_109.categoryId));
         refreshRoomDesc(var_165,var_109);
         refreshExtraCont();
         refreshInfo(var_165,"trading_allowed",var_109.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_211,Tabs.const_209,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
