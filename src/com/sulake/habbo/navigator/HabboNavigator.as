package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_903:ISessionDataManager;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_274.startSearch(Tabs.const_211,Tabs.const_281,param1);
      ...
      override public function dispose() : void
      {
         ...
         if(var_903)
         {
            var_903.release(new IIDSessionDataManager());
            var_903 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_903 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_274.startSearch(Tabs.const_250,Tabs.const_193);
         var_438.getTab(Tabs.const_250).tabPageDecorator.tabSelected();
      }
