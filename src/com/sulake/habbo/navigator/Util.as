package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1450:CutToHeight = new CutToHeight();
      
      private static var var_1451:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1451.beforeSearch(param2,param1,param3);
         binarySearch(var_1451,param2.length - 1);
      }
   }
}
