package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1422,this._model.mode != ThumbnailEditorModel.const_54);
         setEnabled(var_1421,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1422 = IButtonWindow(find("top_tab"));
         var_1421 = IButtonWindow(find("obj_tab"));
         var_1758 = IWindowContainer(find("tile_grid"));
         var_1759 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1422,onTopTabButton);
         Util.setProcDirectly(var_1421,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1758;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_414)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1759;
