package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_414:int = 10;
      ...
      private var var_1836:Dictionary;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_812 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_812.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
      ...
      {
         return Point(this.var_1836[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_812.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_812.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_753 + _loc3_,param2 * const_1053);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1192 == null)
         {
            var_1192 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1192,var_1192.rect,new Point(0,0),null,null,true);
      }
   }
}
