   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1376:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_289:
      ...
      private function onNavigatorSettings(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(false)
            {
               if(_navigator.configuration.method_4("friend.id"))
               {
                  _loc4_ = 0;
                  _navigator.send(new FollowFriendMessageComposer(int(_navigator.configuration.getKey("friend.id"))));
               }
               if(_navigator.configuration.method_4("forward.type") && _navigator.configuration.method_4("forward.id"))
               {
