package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_768:IDropMenuWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1397 = IWindowContainer(find("event_type_disabled_cont"));
            var_1653 = ITextWindow(find("event_type_disabled_text"));
            var_1395 = ITextWindow(find("create_caption"));
            var_1396 = ITextWindow(find("edit_caption"));
            var_1125 = IButtonWindow(find("create_button"));
            var_1124 = IButtonWindow(find("edit_button"));
            var_1654 = IButtonWindow(find("cancel_button"));
            var_1126 = IButtonWindow(find("end_button"));
            var_768 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1125,onCreateButtonClick);
            Util.setProcDirectly(var_1124,onEditButtonClick);
            Util.setProcDirectly(var_1126,onEndButtonClick);
            Util.setProcDirectly(var_1654,onCancelButtonClick);
            ...
            var_769 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
