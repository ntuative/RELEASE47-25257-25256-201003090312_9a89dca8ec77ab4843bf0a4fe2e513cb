package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1256:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_845.setText(_loc1_.name);
         var_1255.setText(_loc1_.description);
         var_1006.setText("");
         var_1252.setText("");
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1495.visible = _inRoom;
         var_1979.visible = var_479;
         var_1980.visible = !var_479;
         if(var_479)
         {
         ...
         var_1492.text = !!var_479 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1494.name,var_1254.name,var_1004.name,var_1007.name,var_1257.name,var_1495.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_845.getText();
         _loc2_.description = var_1255.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_389;
         }
         ...
         _loc2_.allowPets = var_1258.isSelected;
         _loc2_.allowFoodConsume = var_1253.isSelected;
         _loc2_.allowWalkThrough = var_1256.isSelected;
         _loc2_.tags = new Array();
         addTag(var_767,_loc2_.tags);
         addTag(var_769,_loc2_.tags);
         this.clearErrors();
         this.var_1003 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_400 || var_1003 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_1003 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1242)
         {
         ...
         {
            this.var_1255.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1342)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_575,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_855,onDoorModePasswordUnselect);
         ...
         this.var_845 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1255 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_767 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_769 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         ...
         this.var_1258 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1253 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1256 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         ...
         var_1004 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1007 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1495 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1257 = IWindowContainer(_window.findChildByName("footer_container"));
         var_259 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1005 = IWindowContainer(_window.findChildByName("password_container"));
         var_1980 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1979 = ITextWindow(_window.findChildByName("advanced_caption"));
