package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_747:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1428)
         {
            case RecyclerStatusMessageEvent.const_1381:
               var_251 = const_340;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_940:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1192:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1428 != RecyclerStatusMessageEvent.const_940;
      }
      
      private function get statusActive() : Boolean
      {
         return var_251 != const_747;
      }
      ...
      {
         return active && var_251 == const_340;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_867:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1178:
