package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_432:ICatalogNavigator;
      ...
      private var var_2221:GiftWrappingConfiguration;
      ...
      {
         return var_345.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_161.credits = _loc3_.balance;
         updatePurse();
         if(!var_2220 && var_521 != null)
         {
            var_521.playSound(HabboSoundTypesEnum.const_925);
         }
         var_2220 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_345.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_81)
         {
            _loc3_ = var_345.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               var_1344 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2221 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_432 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_161.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_161.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            ...
            _communication.getHabboMainConnection(null).send(new GetIsOfferGiftableComposer(param1.method_2));
         }
      }
      ...
      {
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      {
         _communication.getHabboMainConnection(null).send(new PurchaseFromCatalogComposer(param1.pageId,param2.method_2,param3));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_432.buildCatalogIndex(_loc2_);
         if(var_1084 != "")
         {
            var_432.openPage(var_1084);
            var_1084 = "";
         }
         else
         {
            var_432.openFrontPage();
         }
      }
      ...
      public function purchaseProductAsGift(param1:ICatalogPage, param2:Offer, param3:String, param4:String, param5:String, param6:int, param7:int, param8:int) : void
      {
         ...
         _loc9_.send(new PurchaseFromCatalogAsGiftComposer(param1.pageId,param2.method_2,param3,param4,param5,param6,param7,param8));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_161.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_161.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_161.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_161.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_161.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2222 && var_521 != null)
         {
            var_521.playSound(HabboSoundTypesEnum.const_918);
         }
         var_2222 = false;
      }
