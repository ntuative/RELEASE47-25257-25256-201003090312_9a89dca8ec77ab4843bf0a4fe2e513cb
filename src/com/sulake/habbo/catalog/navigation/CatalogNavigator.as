package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2342:String = "catalog.page.club";
      
      private var var_2370:String = "magic.credits";
      ...
      {
         _catalog.openCatalogPage(var_2342,true);
      }
      ...
      private function method_6(param1:NodeData, param2:int) : ICatalogNode
      {
         var _loc5_:* = null;
         ...
         {
            _loc4_.addChild(method_6(_loc5_,param2));
         }
         return _loc4_;
      }
   }
