package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1425:uint = 4.294967295E9;
      
      private const const_1424:uint = 4.293848814E9;
      ...
      {
         if(this.var_80 == null || this.var_80.method_2 != param1.method_2)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1424) : uint(const_1425);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_537,var_80,var_972);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_252) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_552[var_186]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_553[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_537,var_80,var_972,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_204:
                  ...
                  break;
               case ProductTypeEnum.const_405:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1441 = _loc1_.stuffTypes;
            var_552 = _loc1_.boxTypes;
            var_553 = _loc1_.ribbonTypes;
            var_800 = var_1441[0];
            var_186 = var_552[0];
            _ribbonIndex = var_553[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_252) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_252);
         }
         var_252 = param1;
         if(var_252 < 0)
         {
            var_252 = _loc2_.numListItems - 1;
         }
         if(var_252 >= _loc2_.numListItems)
         {
            var_252 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_252) as IWindowContainer;
