package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1322:IProductData;
      ...
      {
         super();
         var_1321 = param1.productType;
         var_1320 = param1.furniClassId;
         var_1060 = param1.extraParam;
         var_1059 = param1.productCount;
         var_1323 = param1.expiration;
         var_1322 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_81:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1060);
               break;
