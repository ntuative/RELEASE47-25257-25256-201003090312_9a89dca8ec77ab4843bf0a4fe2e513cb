package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1395:String = "ctlg_";
      ...
      {
         var _loc2_:String = const_1395 + param1;
         ...
         var_1367 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1367) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_779);
      }
      ...
      {
         return _localization.getLinks(var_779);
      }
