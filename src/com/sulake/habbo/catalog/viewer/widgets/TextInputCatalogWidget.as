package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1089 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1089 != null)
         {
            var_1089.addEventListener(WindowKeyboardEvent.const_623,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1089.text));
      }
   }
}
