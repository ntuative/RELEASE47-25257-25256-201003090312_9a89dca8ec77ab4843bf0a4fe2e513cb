package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_429 >= var_314.length)
         {
            return "";
         }
         var petColor:IPetColor = var_314[var_429] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_605[var_1562] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_429 = param1.index;
         if(var_429 < 0 || var_429 > var_314.length)
         {
            var_429 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_147,onTextWindowEvent);
         var_590 = new Map();
         ...
         var_905 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_314 = [];
         var_605 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_905);
               if(_loc11_)
               {
                  var_605 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_605.length)
         {
            _loc12_ = var_605[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_905,_loc12_.id),getRaceLocalizationKey(var_905,_loc12_.id)));
            _loc6_++;
         }
         var_590.add(var_905,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_917,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_429 >= 0 && var_429 < var_314.length)
         {
            _loc7_ = var_314[var_429] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_605[var_1562] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_905,_loc3_.id,_loc2_,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_303,AvatarAction.const_525);
