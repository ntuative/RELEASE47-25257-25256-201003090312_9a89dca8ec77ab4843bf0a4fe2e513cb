package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_866:MarketPlaceOfferData;
      
      private const const_1421:int = 1;
      
      private const const_1639:int = 40;
      ...
      private const const_1640:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_417)
         {
            var_417 = new Timer(25);
            var_417.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_867 = 0;
         populateList();
         var_417.start();
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1421);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_416.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_417)
         {
            var_417.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_417 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_867 >= var_590.length)
            {
               return true;
            }
            addListItem(var_590.getWithIndex(var_867));
            ++var_867;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_866.method_2);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_147)
         {
      ...
      private function onOfferListEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "buy_button":
                  marketPlace.buyOffer(_loc5_.method_2);
                  break;
               case "more_button":
                  showDetails(_loc5_);
            }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_416));
            _loc7_.selection = 0;
         }
      }
