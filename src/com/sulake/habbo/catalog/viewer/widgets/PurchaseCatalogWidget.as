   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_387:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2144) as IWindowContainer;
               break;
            ...
            case Offer.const_356:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_2146) as IWindowContainer;
               break;
         ...
         var_1544 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         var_1545 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         var_1543 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(var_80 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_80,page,var_2145);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            var_2144 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            var_2142 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            var_2146 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         if(_loc4_ != null)
         {
            var_2143 = _loc4_.content as XML;
         }
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,onSelectProduct);
         events.addEventListener(WidgetEvent.const_911,onSetParameter);
      }
      
      private function onSetParameter(param1:SetExtraPurchaseParameterEvent) : void
      {
         var_2145 = param1.parameter;
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_1544 != null)
         {
            ...
            var_1544.caption = "${catalog.purchase.price.credits}";
         }
         if(var_1545 != null)
         {
            _loc2_.registerParameter("catalog.purchase.price.pixels","pixels",String(var_80.priceInPixels));
            var_1545.caption = "${catalog.purchase.price.pixels}";
         }
         if(var_1543 != null)
         {
            ...
            var_1543.caption = "${catalog.purchase.price.credits+pixels}";
         }
         if(var_886 != null)
         {
            var_886.enable();
