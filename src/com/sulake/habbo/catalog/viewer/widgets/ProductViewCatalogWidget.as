package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1195:IScrollbarWindow;
      
      protected var var_1376:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1157.text = "${" + _loc3_.name + "}";
            var_1158.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1157.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_390:
                  _loc4_ = var_1196.clone();
                  if(var_559 != null)
                  {
                     var_559.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_559,var_1195,var_1376);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_204:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_303,AvatarAction.const_641);
                              _loc13_.appendAction(AvatarAction.const_584,_loc6_.productClassId);
      ...
      {
         var_1157 = _window.findChildByName("ctlg_product_name") as ITextWindow;
