package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         super(param1);
         var_933 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = var_1558.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      {
         var _loc1_:String = var_1558.getValue(var_904.productContainer.firstProduct.extraParam.toLowerCase());
