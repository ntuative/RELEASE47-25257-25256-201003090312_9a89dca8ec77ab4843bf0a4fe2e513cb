package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_562[var_990] as Array;
      ...
      {
         var _loc2_:Offer = var_562[var_990][var_1872];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_418 || _loc1_.pricingModel == Offer.const_432)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_81 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_989.indexOf(_loc5_) == -1)
                        {
                           var_989.push(_loc5_);
                           var_562.push(new Array());
                        }
                        _loc6_ = var_989.indexOf(_loc5_);
                        (var_562[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_562)
         {
            if(var_1872 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1872] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_990 = var_933.getGridItemIndex(param1.view);
