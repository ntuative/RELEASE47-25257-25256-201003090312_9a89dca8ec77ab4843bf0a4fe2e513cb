   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_371,0,0,_loc4_,var_1488,var_841,var_840));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1975 = int(_config.getKey("interstitial.interval","30000"));
         var_1973 = int(_config.getKey("interstitial.show.time","5000"));
         var_1489 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1245 = _loc2_.imageUrl;
         var_1488 = _loc2_.clickUrl;
         if(var_1245 != "" && var_1488 != "")
         {
            _loc3_ = var_1245;
            ...
            _loc4_ = new URLRequest(var_1245);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1244 != "")
         {
            ...
            if(var_225 == null)
            {
               var_225 = new Timer(var_1973,1);
               var_225.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_225.reset();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_459,0,0,param1.bitmapData,var_1974));
            var_685 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1489 > 0 && var_1487 >= var_1489)
         {
            return false;
         }
