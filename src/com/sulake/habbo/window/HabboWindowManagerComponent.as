package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1168:ProfilerAgentTask;
      
      private var var_1167:IEventDispatcher;
      
      private var var_2361:uint = 0;
      
      private var var_1170:ProfilerAgentTask;
      
      private var var_1169:ProfilerOutput;
      
      private var var_652:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1167 = Component(param1).events;
         var_384 = new Array();
      ...
      {
         return var_215[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_215[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_652 = new WindowRenderer(_loc4_);
         var_215 = new Array(const_342);
         var _loc6_:int = 0;
         while(_loc6_ < const_342)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_652,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_215[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_211 = var_215[const_1046];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_211.getMouseCursor().defineCustomCursorType(MouseCursorType.const_330,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_211.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1182,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_215[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_215.pop()).dispose();
            }
            var_215 = null;
            while(false)
            {
      ...
      {
         return var_215[param1].getDesktopWindow().getChildAt(var_211.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1169 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1169 = new ProfilerOutput(_loc3_,this,var_652);
               var_1168 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1168);
               var_1170 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1170);
               var_971 = true;
            }
         }
      }
      ...
      {
         return var_211.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1167.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_342 - 1;
            while(_loc2_ >= 0)
            {
               var_215[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_971)
         ...
         var_1167.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_342)
         {
            var_215[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_971)
         {
         ...
         var_1167.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_384[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_384[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_211.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1317,param2.name + ": " + param2.toString());
            }
