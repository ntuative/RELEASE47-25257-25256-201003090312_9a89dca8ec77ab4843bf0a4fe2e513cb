package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_439.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_439.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_439.removeStopEventListener(refresh);
            var_439 = null;
            _windowManager = null;
            var_652 = null;
            _disposed = true;
