package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1724 = parseInt(param1.@precedence);
         var_1722 = String(param1.@activepartset);
         var_1726 = String(param1.@assetpartdefinition);
         var_1723 = String(param1.@lay);
         var_1301 = String(param1.@geometrytype);
         var_1614 = Boolean(parseInt(param1.@main));
         var_1720 = Boolean(parseInt(param1.@method_1));
         var_1725 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_608.add(param1,new Map());
         }
         var _loc4_:Map = var_608.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_608.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1140.concat(getTypePrevents(param1));
      }
