package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1465,var_1467,var_1468,_alphaMultiplier);
         var_1038 = generatePaletteMapForGrayscale(var_2094,var_2093);
      }
      
      public function get reds() : Array
      {
         return var_1038.getValue("reds") as Array;
      }
      ...
      {
         return var_1038.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1038.getValue("greens") as Array;
      }
      ...
      {
         return var_1038.getValue("alphas") as Array;
      }
