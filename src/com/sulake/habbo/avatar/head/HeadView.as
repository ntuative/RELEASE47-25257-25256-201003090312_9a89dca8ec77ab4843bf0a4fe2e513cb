package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_116,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_151,param2,param3);
         var_33["null"] = new AvatarEditorGridView(param1,FigureData.const_141,param2,param3);
