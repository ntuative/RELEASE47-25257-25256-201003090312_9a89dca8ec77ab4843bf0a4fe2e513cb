package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1484 = var_13.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_100);
         var_1484.setDirection(AvatarSetType.const_39,int(FigureData.const_980));
         _image = var_1484.getImage(AvatarSetType.const_39);
         _view.udpate(_image);
      }
