package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_664:IItemListWindow;
      
      private var var_558:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_814:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_664 = _window.findChildByName("mylooks") as IItemListWindow;
         var_558 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_814 = _window.findChildByName("selector") as IItemListWindow;
         var_1454 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_261,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_664.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_814.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_557 = [];
         while(true)
         {
            ...
            var_814.addListItem(_loc1_.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_664.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_664.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_814.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_813 * 8 + var_558.getListItemIndex(param2.parent);
