package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1426:int = 60000;
      ...
      private var var_834:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         if(_loc4_ == null || !_loc4_.definition.method_5)
         {
            return null;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.method_5)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_650)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_413)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_74.getParts(param1,(var_834 as AvatarImage).getFigure(),_loc6_,var_1301,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_74.getCanvas(var_202,var_1301);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_1015 || _loc32_ == AvatarAction.const_556) && (_loc6_ == AvatarBodyPartType.const_292 || _loc6_ == AvatarBodyPartType.const_1369 || _loc6_ == AvatarBodyPartType.const_1239) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_202 == AvatarScaleType.const_52)
            {
               _loc30_.x += 67;
            }
            else
