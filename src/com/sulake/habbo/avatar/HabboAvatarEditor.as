package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_639.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1148)
         {
            ...
            var_457["null"] = new FigureData(this);
            var_457["null"] = new FigureData(this);
            _loc1_ = var_457["null"];
            _loc2_ = var_457["null"];
            ...
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_908,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_46,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_292,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1223,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_816,new WardrobeModel(this));
            var_1148 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_961 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_961 >= _loc14_.clubLevel))
               {
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1241)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_961 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_816);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_639.getPalette(param1);
      }
      ...
      {
         var_639 = var_543.getFigureData(AvatarType.const_82);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_211 == null)
            {
               var_211 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_211.addChild(_view.window);
               var_211.center();
               var_211.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_908);
         if(var_544 != null)
         {
            var_544.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_961 = param3;
         var _loc4_:FigureData = var_457[param2];
         if(_loc4_ == null)
         {
            return;
         }
