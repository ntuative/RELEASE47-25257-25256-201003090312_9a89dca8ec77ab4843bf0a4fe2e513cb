package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         var_13.figureData.savePartData(FigureData.const_59,_loc4_.id,_loc3_.getCurrentColorIds(),true);
      ...
      private function init() : void
      {
         ...
         var_15 = new Map();
         var_15["null"] = var_13.generateDataContent(this,FigureData.const_59);
      ...
      public function toggleColorSelection(param1:String, param2:int) : void
      {
         ...
         var_13.figureData.savePartSetColourId(FigureData.const_59,_loc3_.getCurrentColorIds(),true);
         updateView();
      }
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc2_:int = var_13.figureData.getPartSetId(FigureData.const_59);
         var _loc3_:Array = var_13.figureData.getColourIds(FigureData.const_59);
