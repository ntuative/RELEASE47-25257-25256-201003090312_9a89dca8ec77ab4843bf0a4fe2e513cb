package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1957:PartOffsetData;
      
      private var var_837:AvatarActionManager;
      
      private var var_103:IAssetLibrary;
      
      private var var_2302:IAssetLibrary;
      
      private var var_1379:Boolean = false;
      
      private var var_1958:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_681 = new AnimationManager();
         var_682 = param4;
         var_1957 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_837.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_682)
         {
            case AvatarType.const_82:
               _loc1_ = var_103.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_103.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_103.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_103.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_398.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_103.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_103.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_399.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_837.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_837.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.method_5)
         {
            _loc6_ = param1.definition.state + "." + param1.actionParameter;
            _loc7_ = var_681.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1141[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_837.getDefaultActionType();
         var _loc7_:Array = var_398.getActiveParts(param3.definition);
         if(param3.definition.method_5)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_681.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_399.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_399.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_398.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_398.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_82:
               if(var_103.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_103.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_103.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_103.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_682 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_82:
               if(var_103.hasAsset(_loc5_))
               {
                  var_103.removeAsset(var_103.getAssetByName(_loc5_));
               }
               var_1485.add(new AvatarStructureDownload(var_103,_loc5_,var_399));
               break;
            case AvatarType.PET:
         }
      ...
      {
         return var_681.getAnimation(param1);
      }
      ...
      {
         var_837 = new AvatarActionManager(var_103,var_682);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_103.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_103.getAssetByName("dance" + _loc1_).content as XML;
            var_681.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_103.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_103.getAssetByName("fx" + _loc1_).content as XML;
            var_681.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_837.sortActions(param1);
      }
   }
}
