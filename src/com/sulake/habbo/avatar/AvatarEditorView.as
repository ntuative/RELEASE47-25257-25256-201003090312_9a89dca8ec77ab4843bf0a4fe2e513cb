package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1410:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1365 == null)
         {
            ...
            var_1365 = var_13.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1593 == null)
         {
         ...
         var_332 = new Timer(1000);
         var_332.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_456)
         {
            ...
            var_456 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_456.procedure = stripClubDialogEventProc;
            var_456.center();
         }
         else
         {
            var_456.visible = true;
            var_456.center();
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1410 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_657 != null)
         {
            toggleCategoryView(var_657,true);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_332.stop();
            var_332.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_332 = null;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_657 = param1;
         var_1410.setSelected(var_1410.getSelectableByName(param1));
         _window.invalidate();
      }
